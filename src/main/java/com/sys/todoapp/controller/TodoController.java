package com.sys.todoapp.controller;

import com.sys.todoapp.entity.TodoEntity;
import com.sys.todoapp.repository.TodoRepository;
...
@Controller
@RequiredArgsConstructor // to inject
public class TodoController {
    ...
    public String update(@PathVariable Long id) {
        ...
        boolean isCompleted=existingTodo.getCompleted();
